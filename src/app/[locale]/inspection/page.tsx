...
const scopeIcons = ["inspect", "derrick", "certificate", "crate", "wrench", "factory"] as const;
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <JsonLd
        data={[
          ...
          serviceSchema({
            ...
            description: t.seo.inspection.description,
            serviceType: "Industrial equipment inspection",
          }),
        ]}
      />
      ...
      <RelatedServices locale={locale} current="inspection" />
